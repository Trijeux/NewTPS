...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private bool _wasShotForAnim;
        [SerializeField] private bool _ammoForAnim;
        ...
        private void Start()
        {
            ...
            _hasAnimator = TryGetComponent(out _animatorForPlayer);
        ...
        private void GroundedCheck()
        {
            ...
            if (_hasAnimator)
            {
                _animatorForPlayer.SetBool(_animIDGrounded, Grounded);
            }
        }


        private void AimingAndAnimGun()
        { 
            ...
            if (_input.isAiming)
            {
                ...
                if (_input.isShot && _shootingSysteme._ammo > 0 && !_wasShotForAnim)
                {
                    ...
                    _wasShotForAnim = _shootingSysteme._wasShot;
                }
                else
                {
            ...
            {
                _animatorForPlayer.SetBool(_animIDReload, true);
                _ammoForAnim = false;
            }
            else
            {
                _animatorForPlayer.SetBool(_animIDReload, false);
            }

            if (_shootingSysteme._ammo <= 11)
            {
                _ammoForAnim = true;
            }
        }
        ...
        private void Move()
        {
            ...
            float targetSpeed = _input.sprint && !_input.isAiming ? SprintSpeed : MoveSpeed;
            ...
            if (_hasAnimator)
            {
                _animatorForPlayer.SetFloat(_animIDSpeed, _animationBlend);
                _animatorForPlayer.SetFloat(_animIDMotionSpeed, inputMagnitude);
            }
        }
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                if (_input.jump && _jumpTimeoutDelta <= 0.0f)
                {
                    ...
                    if (_hasAnimator)
                    {
                        _animatorForPlayer.SetBool(_animIDJump, true);
                    }
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (_hasAnimator)
                    {
                        _animatorForPlayer.SetBool(_animIDFreeFall, true);
                    }
                }
